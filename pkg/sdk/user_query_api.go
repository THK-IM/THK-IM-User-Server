...
func (d defaultUserQueryApi) BatchQueryUsers(req *dto.BatchQueryUser, claims baseDto.ThkClaims) (map[int64]*dto.BasicUser, error) {
...
func NewUserQueryApi(sdk conf.Sdk, logger *logrus.Entry) UserQueryApi {
	return defaultUserQueryApi{
